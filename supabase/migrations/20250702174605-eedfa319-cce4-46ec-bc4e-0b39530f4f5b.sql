-- Corriger la fonction get_game_with_participants pour inclure les informations d'équipe
...
BEGIN
  ...
  -- Récupérer les participants avec leurs profils COMPLETS incluant les informations d'équipe
  ...
  -- Récupérer le profil COMPLET du créateur
