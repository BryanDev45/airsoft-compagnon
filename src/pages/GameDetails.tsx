...
const GameDetails = () => {
  ...
  const game = {
    ...
    price: "35€",
    images: ["https://images.unsplash.com/photo-1624881513483-c1f3760fe7ad?q=80&w=2070&auto=format&fit=crop", "https://images.unsplash.com/photo-1624881514789-5a8a7a82b9b5?q=80&w=2070&auto=format&fit=crop", "https://images.unsplash.com/photo-1625008928888-27fde18fd355?q=80&w=2069&auto=format&fit=crop"],
    scenarios: ["Capture de drapeaux", "Escorte VIP", "Défense de position", "Extraction d'otages"],
    comments: [{
      author: "Airsoft_Pro",
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2 mt-4 md:mt-0">
                ...
                <Button className={`${isRegistered ? 'bg-green-600 hover:bg-green-700' : 'bg-airsoft-red hover:bg-red-700'}`} onClick={handleRegister}>
                  {isRegistered ? <>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <div className="rounded-lg overflow-hidden mb-8">
                <img src={game.images[0]} alt={game.title} className="w-full h-[300px] object-cover" />
                <div className="bg-white p-2 grid grid-cols-3 gap-2">
                  {game.images.slice(1, 4).map((img, idx) => <img key={idx} src={img} alt={`${game.title} ${idx + 1}`} className="h-20 w-full object-cover rounded" />)}
                </div>
              </div>
                ...
                <Tabs defaultValue="details">
                  ...
                  <TabsContent value="details" className="p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                      {game.scenarios.map((scenario, idx) => <li key={idx}>{scenario}</li>)}
                    </ul>
                    
                    <div className="bg-gray-100 p-4 rounded-lg">
                      <h3 className="text-lg font-semibold mb-2">Organisé par</h3>
                      <div className="flex items-center gap-3">
                        <img src={game.organizer.avatar} alt={game.organizer.name} className="w-12 h-12 rounded-full object-cover" />
                        <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-gray-700">
                          <div className="flex items-center justify-between">
                            <span>Toilettes:</span>
                            <Badge className={game.equipmentLimitations.toilets ? "bg-green-500" : "bg-red-500"}>
                              {game.equipmentLimitations.toilets ? "Disponibles" : "Non disponibles"}
                            </Badge>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Parking:</span>
                            <Badge className={game.equipmentLimitations.parking ? "bg-green-500" : "bg-red-500"}>
                              {game.equipmentLimitations.parking ? "Disponible" : "Non disponible"}
                            </Badge>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Location de matériel:</span>
                            <Badge className={game.equipmentLimitations.equipmentRental ? "bg-green-500" : "bg-red-500"}>
                              {game.equipmentLimitations.equipmentRental ? "Disponible" : "Non disponible"}
                            </Badge>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-gray-700">
                          <div className="flex items-center justify-between">
                            ...
                            <Badge className={game.equipmentLimitations.manualValidation ? "bg-amber-500" : "bg-green-500"}>
                              {game.equipmentLimitations.manualValidation ? "Requise" : "Automatique"}
                            </Badge>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Réplique requise:</span>
                            <Badge className={game.equipmentLimitations.replicaRequired ? "bg-amber-500" : "bg-green-500"}>
                              {game.equipmentLimitations.replicaRequired ? "Oui" : "Non"}
                            </Badge>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Partie privée:</span>
                            <Badge className={game.equipmentLimitations.privateGame ? "bg-amber-500" : "bg-green-500"}>
                              {game.equipmentLimitations.privateGame ? "Oui" : "Non"}
                            </Badge>
                          </div>
                        </div>
                      </div>
                  ...
                  <TabsContent value="comments" className="p-6">
                    ...
                    <div className="space-y-6 mb-6">
                      {game.comments.map((comment, idx) => <div key={idx} className="flex gap-4">
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6">
                    <Button className={`w-full ${isRegistered ? 'bg-green-600 hover:bg-green-700' : 'bg-airsoft-red hover:bg-red-700'}`} onClick={handleRegister}>
                      {isRegistered ? <>
                          <Check size={16} className="mr-2" />
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="bg-gray-200 rounded-lg h-[200px] mb-4">
                    <LocationMap location={game.location} coordinates={game.coordinates} />
                  </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {game.participants.slice(0, 8).map((participant, idx) => <div key={idx} className="flex flex-col items-center">
                        <div className="relative">
                          <img src={participant.avatar} alt={participant.name} className="w-10 h-10 rounded-full object-cover" />
                          {participant.status === "online" && <div className="absolute -top-1 -right-1 w-4 h-4 bg-green-500 rounded-full border-2 border-white"></div>}
                        </div>
                      </div>)}
          ...
          <div className="mt-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {game.participants.map((participant, idx) => <div key={idx} className="flex items-center gap-3 p-3 border rounded-md hover:bg-gray-50 transition-colors">
                    <div className="relative">
                      <img src={participant.avatar} alt={participant.name} className="w-12 h-12 rounded-full object-cover" />
                      {participant.status === "online" && <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-white"></div>}
                    </div>
