...
const TeamSearchResults = ({
  ...
  return <div className="space-y-4">
      ...
      {filteredTeams.length === 0 ? <div className="text-center py-12">
        ...
        </div> : filteredTeams.map(team => <div key={team.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="flex-grow">
                <div className="flex flex-wrap items-center gap-2 mb-1">
                  ...
                  {team.isAssociation && <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
                      Association
                    </Badge>}
                </div>
