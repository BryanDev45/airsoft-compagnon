        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {mode === 'fps' ? <div>
                ...
                <div className="mt-2">
                  <Slider value={[joules * 100]} min={0} max={300} step={1} onValueChange={value => setJoules(value[0] / 100)} className="py-4" />
                  <div className="flex justify-between text-sm text-muted-foreground">
                    <span>0.00</span>
                    <span>3.00</span>
                  </div>
          ...
          <div>
            ...
            <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
              <div className={`h-full transition-all ${getReplicaType(joules).color}`} style={{
          ...
          <div className="space-y-2">
            ...
            {commonBBWeights.map(weight => <div key={weight} className="flex justify-between bg-muted p-2 rounded">
