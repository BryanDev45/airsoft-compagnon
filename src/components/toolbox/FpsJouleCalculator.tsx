      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          {mode === 'fps' ? (
            ...
            <div>
              <Label className="text-gray-300">Énergie cinétique (Joules)</Label>
              <div className="mt-2">
                <Slider
                  value={[joules * 100]}
                  min={0}
        ...
        <div>
          ...
          <div className="h-2 w-full bg-gray-700 rounded-full overflow-hidden">
            <div 
              ...
              style={{ width: `${Math.min((joules / 4) * 100, 100)}%` }}
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          {commonBBWeights.map((weight) => (
            <div key={weight} className="flex justify-between bg-gray-800 p-2 rounded">
              <span>{weight}g</span>
