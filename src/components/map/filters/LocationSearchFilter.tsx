...
const LocationSearchFilter: React.FC<LocationSearchFilterProps> = ({
  ...
  return <div>
      ...
      <div className="relative">
        ...
        <Input type="text" placeholder="Ville, département..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-9 bg-gray-700 border-gray-600 text-white placeholder:text-gray-400" />
      </div>
