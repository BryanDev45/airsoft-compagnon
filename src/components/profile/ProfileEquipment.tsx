  ...
  return (
    <div className="space-y-8 w-full">
      {equipmentTypes.map(type => {
        ...
        return (
          <div key={type} className="bg-gray-50 p-6 rounded-lg border border-gray-100 shadow-sm w-full">
            ...
            <div className="grid grid-cols-1 gap-5">
              {items.map(item => (
                <Card key={item.id} className="overflow-hidden transition-all duration-200 hover:shadow-md w-full">
                  <div className="md:flex">
                    <div className="h-56 md:h-auto md:w-1/3 bg-gray-100 flex items-center justify-center relative">
                      {item.image ? (
                        <img 
                          src={item.image} 
