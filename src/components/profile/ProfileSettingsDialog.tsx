          ...
          <TabsContent value="verification">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {user.verified ? <Badge className="bg-blue-500">Vérifié</Badge> : <Badge variant="outline" className="bg-gray-100 text-gray-700">Non vérifié</Badge>}
              </div>
              
              {user.verified ? <Alert className="bg-blue-50 border-blue-200">
                  <CheckCircle2 className="h-4 w-4 text-blue-500" />
                  <AlertDescription>
                    Votre compte est vérifié. Votre badge de vérification est visible sur votre profil.
                  </AlertDescription>
                </Alert> : verificationRequested ? <Alert className="bg-yellow-50 border-yellow-200">
                  <AlertDescription>
                  ...
                  <Button onClick={handleRequestVerification} className="w-full bg-airsoft-red hover:bg-red-700">
