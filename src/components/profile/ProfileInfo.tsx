        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start">
              ...
              <span className="text-sm text-gray-500 mr-3 mt-1">Langue parlée</span>
            ...
            {isOwnProfile && (
              <div className="flex items-start">
                ...
                <span className="text-sm text-gray-500 mr-3 mt-1">Numéro de téléphone</span>
                <div className="flex-1">
                  {isEditingPhone ? (
                    <div className="space-y-2">
                      <Input
            ...
            <div className="flex items-start">
              ...
              <span className="text-sm text-gray-500 mr-3 mt-1">Localisation</span>
              <div className="flex-1">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-grow">
                ...
                {profileData?.team ? (
                  <div className="flex items-center justify-between">
                    {profileData?.team_id ? (
                      <Link to={`/team/${profileData.team_id}`} className="font-medium transition-colors duration-200">
                        {profileData.team}
                      </Link>
                    ) : (
