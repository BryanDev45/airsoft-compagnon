...
import { FormattedGame, fetchParticipantCounts, formatParticipatedGame, formatCreatedGame, updateUserGamesStats } from '../user-profile/gameFormatters';

/**
 * Hook refactorisé pour la gestion des parties utilisateur avec correction des stats
 */
export const useUserGamesRefactored = (userId: string | undefined) => {
  ...
  const fetchUserGames = async () => {
    ...
    try {
      ...
      // CORRECTION: Mettre à jour les statistiques même pour les autres utilisateurs
